            ...
            if is_substitute == 'no':
                ...
                if can_replay:
                    ...
                    if is_replay == 'yes':
                        ...
                        print("----------")
                        if hand_score >= score_replay:
                            total_score.append(hand_score)
                        else:
                            total_score.append(score_replay)
                    else:
                        total_score.append(hand_score)
                else:
                    total_score.append(hand_score)
            elif is_substitute == 'yes':
                ...
                if can_replay:
                    ...
                    total_score.append(hand_score)                    
            else: raise NameError("substitute letter must be yes or no!")
        else:
            hand_score = play_hand(hand,word_list)
            if can_replay:
                is_replay = input("Would you like to replay the hand? ")
